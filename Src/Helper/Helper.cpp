...
void cardManagerMenu(){
    ...
    cout <<"|   6.Hien Thi Cac ID Giao Dich Cua The Ngan Hang                   |" << endl;  
    cout <<"|   7.Tim Kiem The Ngan Hang                                        |" << endl;
    cout <<"|   8.Hien Thi Danh Sach The Ngan Hang                              |" << endl;
    cout <<"|   9.Hien Thi Danh Sach The Ngan Hang Cua Khach Hang               |" << endl;  
    cout <<"|   10.Xoa Tat Ca The Ngan Hang Cua Khach Hang                      |" << endl;  
    cout <<"|   11.Thong Ke The Ngan Hang Duoc Tao Theo Ngay                    |" << endl;
    cout <<"|   12.Exit                                                         |" << endl;
    cout <<"|                                                                   |" << endl;
    cout <<"---------------------------------------------------------------------" << endl;
}
